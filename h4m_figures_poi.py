...
for line in lines:
    ...
    # lng_list.append(float(j['Lng']))
    # lng_list.append(float(j['Lat']))
...
# plt.scatter(lng_list, lat_list, marker='.', s=1)
...
ax.scatter(lng_list, lat_list, marker='.', s=1, color='blue')
...
with open('../data/H4M/queryout_beijing.json', encoding='utf-8') as json_file:
    data = json.load(json_file)

    # Print the type of data variable
    print("Type:", type(data))

# f = open('../data/H4M/queryout_beijing.json', 'r')
# d = json.loads('../data/H4M/queryout_beijing.json')
# print(d)
exit()
...
v_list = pd.read_pickle(r'../data/H4M/traffic/avg_v_change_pos_list.txt')
# print(v_list.shape)
